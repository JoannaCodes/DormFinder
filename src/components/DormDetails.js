...
const DormDetails = ({navigation, route}) => {
  ...
  return (
    <SafeAreaView
      style={{flex: 1, backgroundColor: COLORS.white, paddingBottom: 16}}>
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* Dorm Images */}
        <View style={style.backgroundImageContainer}>
          <ImageBackground
            style={style.backgroundImage}
            source={{uri: `${DORM_UPLOADS}/${dormref}/${images[0]}`}}>
            {mode === 'guest' ? null : (
              <View style={style.header}>
                <TouchableOpacity
                  ...
                  <Icon
                    name="favorite"
                    size={20}
                    color={dorms.myfavorite === 1 ? COLORS.red : COLORS.grey}
                  />
                </TouchableOpacity>
              </View>
            )}
        ...
        <View style={style.detailsContainer}>
          ...
          {/* Not sure kung ano */}
          <Text style={{color: COLORS.grey}}>{dorms.details}</Text>
          ...
          <Modal visible={isPopupVisible} transparent={true}>
            <ImageViewer
              imageUrls={images.map(image => ({
                url: `${DORM_UPLOADS}/${dormref}/${image}`,
              }))}
          ...
          <View style={{marginTop: 20}}>
            ...
            <View style={{flexDirection: 'row', flexWrap: 'wrap'}}>
              {typeof dorms.hei === 'string' &&
                dorms.hei.split(',').map((school, index) => (
          ...
          <View style={{marginTop: 20}}>
            ...
            <View style={{flexDirection: 'column', marginTop: 5}}>
              ...
              <View style={style.facility1}>
                ...
                {dorms.visitors === 0 ? (
                  <Text style={style.facilityText2}>
              ...
              {dorms.adv_dep === 'N/A' &&
                ...
                dorms.min_stay === 'N/A' && (
                  <Text style={{fontStyle: 'italic', fontSize: 14}}>
                    No Terms for Payment and Duration
                  </Text>
                )}
            </View>
          </View>
